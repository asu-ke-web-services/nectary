...
class String_Utilities_Test extends TestCase {
	public function test_starts_with_returns_true() {
		$needle = '@';
		$haystack = '@asugreen';
	...
	public function test_starts_with_returns_false() {
		$needle = '@';
		$haystack = '.@asugreen';
	...
	public function test_ends_with_returns_true() {
		$needle = 'n';
		$haystack = '@asugreen';
	...
	public function test_ends_with_returns_false() {
		$needle = '@';
		$haystack = '@asugreen';
	...
	public function test_is_json_returns_true() {
		$good_json = '{}';

		$this->assertTrue( is_json( $good_json ) );
	}

	public function test_is_json_returns_false() {
		$bad_json = '{';
	...
	public function test_break_to_newline() {
		$this->assertEquals( "\n", br2nl( '<br>' ) );
		$this->assertEquals( "\n", br2nl( '<br/>' ) );
		$this->assertEquals( "\n", br2nl( '<br    />' ) );
		$this->assertEquals( "\n", br2nl( '<br    >' ) );
	...
	public function test_first_char_returns_the_first_character() {
